...
<script src="//cdn.bootcss.com/angular.js/1.3.15/angular-animate.min.js"></script>
<script src="//cdn.bootcss.com/angular.js/1.3.15/angular-route.min.js"></script>
<script src="//cdn.bootcss.com/angular.js/1.3.15/angular-aria.min.js"></script>
<script src="//cdn.bootcss.com/angular.js/1.3.15/angular-messages.min.js"></script>
    ...
    <md-toolbar class="desktop">
      <div class="md-toolbar-tools">
        ...
        <md-button class="md-icon-button" aria-label="Icon">
          ...
          <md-icon class="md-default-theme" md-svg-icon="/img/fb.svg"></md-icon>
        </md-button>
        <h2>
          <span>Heading</span>
        </h2>
        ...
        <md-button class="md-icon-button" aria-label="Messages">
          ...
          <img src="/img/messages.png" style="width:24px;height:24px;"/>
        </md-button>
      </div>
     </md-toolbar>
